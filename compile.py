...
def compile_gui():
    ...
    main_script = os.path.join(current_dir, "gui_converter.py")
    ...
    cmd = [
        ...
        "--macos-app-icon=" + os.path.join(current_dir, "support", "Success.icns"), # App icon
...
def main():
    ...
    if gui_success and cli_success:
        ...
        print("- GUI application: dist/gui_converter.app")
